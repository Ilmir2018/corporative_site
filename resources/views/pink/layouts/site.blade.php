...
<!-- START BODY -->
<body
    class="no_js responsive {{ (\Illuminate\Support\Facades\Route::currentRouteName() == "home")
 || (\Illuminate\Support\Facades\Route::currentRouteName() == 'portfolios.index')
  || (\Illuminate\Support\Facades\Route::currentRouteName() == 'portfolios.show') ? 'page-template-home-php' : '' }} stretched">
