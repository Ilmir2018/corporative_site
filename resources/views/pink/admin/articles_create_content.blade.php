<div id="content-page" class="content group">
    <div class="hentry group">
        {!! Form::open(['url' => (isset($article->id)) ?
        ...
        <ul>
            ...
            <li class="text-field">
                ...
                <div class="input-prepend">
                    ...
                    {!! Form::text('alias', isset($article->alias) ? $article->alias : old('alias'), ['placeholder' => 'Введите название страницы']) !!}
                </div>
            </li>
            <li class="text-field">
                <label for="name-contact-us">
                ...
                <div class="input-prepend">
                    ...
                    {!! Form::textarea('desc', isset($article->desc) ? $article->desc : old('desc'), ['placeholder' => 'Введите название страницы', 'id' => 'editor']) !!}
                </div>
            </li>
            <li class="text-field">
                <label for="name-contact-us">
                ...
                <div class="input-prepend">
                    ...
                    {!! Form::textarea('text', isset($article->text) ? $article->text : old('text'), ['placeholder' => 'Введите название страницы', 'id' => 'editor2']) !!}
                </div>
            </li>
            ...
            <li class="text-field">
                ...
                <div class="input-prepend">
                    {!! Form::file('image', ['class' => 'filestyle', 'data-buttonText' => 'Выберите изображение']) !!}
                </div>
            </li>
