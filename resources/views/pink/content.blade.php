                        ...
                        <div class="hentry work group portfolio-sticky portfolio-full-description">
                            <div class="work-thumbnail">
                                ...
                                <div class="work-overlay">
                                    ...
                                    <p class="work-overlay-categories"><img src="{{ asset(env('THEME')) }}}/images/woman.png" alt="Categories" />
                                        in: <a href="category.html">{{ $item->filter->title }}</a></p>
                                </div>
                            </div>
