<div id="content-single" class="content group">
    ...
    @if($article)
        ...
        <div class="meta group">
            ...
            <p class="categories"><span>In: <a href="{{ route('articleCat', ['cat_alias' => $article->category->alias]) }}" title="View all posts in {{ $article->category->title }}" rel="category tag">{{ $article->category->title }}</a></span></p>
    ...
    <div id="comments">
        ...
        <ol class="commentlist group">
            ...
            @include(env('THEME').'.blog.comment', ['items' => $comment])
            @endforeach
        </ol>
